...
for anos in total:
    ...
    nc_ano = 'C:/Users/User/media_%s_total.npy' % str(anos)
    nc_ano = np.load(nc_ano)
    
    nc_ano_total = 'C:/Users/User/media_anos_total.npy' 
    nc_ano_total = np.load(nc_ano_total)

    nc_desv = 'C:/Users/User/desv_anos_total.npy'
    ...
    nome = 'C:/Users/User/anomalia_%s_total.npy' % str(anos)
