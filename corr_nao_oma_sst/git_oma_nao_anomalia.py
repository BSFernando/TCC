...
oma = np.loadtxt('C:/Users/User/Downloads/tcc/indices_noaa/amo.txt')
...
nao = np.loadtxt('C:/Users/User/Downloads/tcc/indices_noaa/norm.nao.monthly.txt')
...
for ano in total:
    ...
    for mes in meses:
        ...
        file = np.load('C:/Users/User/Downloads/github/anomalia_%s_%s.npy' % (str(mes), str(ano)))
        file = file[::-1]
...
tabela.to_excel("C:/Users/User/Downloads/github/tabela_meses_anomalia_nao_oma.xlsx")
